...
public class SimpleQueueListenerInstance3 implements MessageListener{
	...
	public void onMessage(Message message){
		...
		try{
			...
			System.out.println("Incoming message instance 3" + messageInString);
			try{
				Thread.sleep(5000l);
				System.out.println("Process finished instance 3");
